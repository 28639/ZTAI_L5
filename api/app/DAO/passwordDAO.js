...
const passwordSchema = new mongoose.Schema({
  userId: { type: mongoose.Schema.Types.ObjectId, ref: 'kl_user', required: true, unique: true },
  password: { type: String, required: true }
}, {
  collection: 'kl_password'
});

const PasswordModel = mongoose.model('kl_password', passwordSchema);
