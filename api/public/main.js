...
/* harmony import */ var _search_bar_search_bar_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./search-bar/search-bar.component */ "./src/app/search-bar/search-bar.component.ts");
/* harmony import */ var _blog_home_blog_home_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./blog-home/blog-home.component */ "./src/app/blog-home/blog-home.component.ts");
...
var appRoutes = [
    ...
    {
        path: 'blog',
        component: _blog_home_blog_home_component__WEBPACK_IMPORTED_MODULE_17__["BlogHomeComponent"],
    },
    {
        path: 'contact',
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _search_bar_search_bar_component__WEBPACK_IMPORTED_MODULE_16__["SearchBarComponent"],
                _blog_home_blog_home_component__WEBPACK_IMPORTED_MODULE_17__["BlogHomeComponent"],
            ...
            providers: [_services_data_service__WEBPACK_IMPORTED_MODULE_13__["DataSerivce"]],
...
var BlogComponent = /** @class */ (function () {
    ...
    BlogComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_data_service__WEBPACK_IMPORTED_MODULE_1__["DataSerivce"]])
    ], BlogComponent);
...
module.exports = "\r\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed consectetur justo ac neque ultrices, sed fringilla metus\r\n  vulputate. Nunc dictum, dolor vel elementum viverra, metus lectus dictum justo, ac placerat tellus justo eget ante.\r\n  Vivamus tincidunt ante enim, vel iaculis elit pellentesque id. Fusce enim ipsum, dapibus at orci non, porttitor\r\n  tempus odio. Morbi quis egestas enim, ac ultricies purus. Proin finibus id tortor sit amet rutrum. Aenean dignissim\r\n  eleifend neque, viverra cursus neque aliquam eget. Sed dapibus accumsan elit, eu mollis libero malesuada vel. Nam\r\n  condimentum, mi id rhoncus maximus, sem nibh eleifend augue, at efficitur lacus elit ac justo. Ut nec mauris nunc.\r\n  Morbi finibus ornare neque, eu mattis justo venenatis non. Nullam eu maximus eros.\r\n  Phasellus tempus metus bibendum, eleifend ipsum sit amet, ullamcorper mi. Fusce pulvinar leo velit, at lacinia velit\r\n  fringilla sit amet. Integer rhoncus varius volutpat. Pellentesque imperdiet sed nunc a porta. Duis mollis elementum\r\n  tellus, vitae volutpat lacus vestibulum quis. Nam porta elit metus, id gravida dolor varius a. Nullam eleifend magna\r\n  vitae quam venenatis, at malesuada augue pretium. Pellentesque tincidunt est condimentum, aliquam tellus eu, congue\r\n  nunc. Vestibulum auctor maximus tortor id consectetur.\r\n  Donec iaculis aliquet lorem, nec pharetra tellus efficitur ac. Cras efficitur dui felis, et rutrum mi egestas at.\r\n  Vivamus mi ligula, lacinia quis tellus pulvinar, fringilla posuere metus. Etiam libero augue, interdum at semper sit\r\n  amet, commodo et lacus. Aenean turpis lacus, elementum id dui in, facilisis suscipit ipsum. Aenean feugiat mi sit\r\n  amet vestibulum vestibulum. Quisque rutrum a eros condimentum gravida. Quisque ac venenatis felis, et molestie nibh.\r\n  Morbi at mauris facilisis, sagittis turpis dignissim, placerat justo. Etiam porta porta sagittis. Ut facilisis est\r\n  ac libero tincidunt euismod. Suspendisse cursus elit turpis. Nam nec lacus quis mauris lacinia egestas vel vel sem.\r\n  Mauris pellentesque lacus velit, sed cursus ante sagittis a. Vestibulum ante ipsum primis in faucibus orci luctus et\r\n  ultrices posuere cubilia Curae; Nam gravida purus et malesuada placerat. Duis egestas elit a commodo aliquam. In\r\n  fringilla arcu ac pulvinar condimentum. Fusce congue eros id nisl posuere imperdiet. Ut semper nisi ante, non\r\n  vulputate arcu facilisis et. Aenean id lorem ornare, mattis dui sed, efficitur dui.\r\n  Pellentesque convallis fermentum bibendum. Praesent aliquam lectus ut metus faucibus, in congue tellus hendrerit.\r\n  Aliquam sed hendrerit mauris, at euismod urna. Proin varius sed urna eget iaculis. Phasellus eu venenatis enim.\r\n  Proin at laoreet massa, ut tincidunt tortor. Duis eu auctor nibh. Aliquam non nunc ante. Nulla et arcu vel libero\r\n  vestibulum finibus. Duis at placerat lorem. Sed placerat augue rutrum purus auctor rutrum. In efficitur faucibus\r\n  justo fringilla pellentesque. Suspendisse gravida ligula a libero luctus mollis. Nam aliquet scelerisque\r\n  posuere.</p>\r\n"
...
module.exports = "<ul>\r\n  <li><a routerLink=\"/home\"><img src=\"../../../assets/strona_glowna.png\" alt=\"strona glowna\"/></a></li>\r\n  <li><a routerLink=\"/blog\">Blog</a></li>\r\n  <li><a routerLink=\"/quiz\">Quiz</a></li>\r\n  <li><a routerLink=\"/contact\">Kontakt</a></li>\r\n</ul>\r\n"
...
/*!******************************************!*\
  !*** ./src/app/services/data-service.ts ***!
  \******************************************/
/*! exports provided: DataSerivce */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DataSerivce", function() { return DataSerivce; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var DataSerivce = /** @class */ (function () {
    function DataSerivce(http) {
        this.http = http;
        this.url = 'https://jsonplaceholder.typicode.com';
    }
    DataSerivce.prototype.getAll = function () {
        return this.http.get(this.url + '/photos')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (x) { return x.slice(0, 10); }));
    };
    DataSerivce.prototype.get = function (id) {
        return this.http.get(this.url + '/photos/' + id);
    };
    DataSerivce = __decorate([
...
module.exports = __webpack_require__(/*! C:\Users\student\IdeaProjects\TAI_LAB4\src\main.ts */"./src/main.ts");
